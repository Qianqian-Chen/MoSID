...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--test_batch', type=int, default=8, help='input test batch size')
        parser.add_argument('--epoch', type=int, default=200, help='number of epochs with the initial learning rate')
